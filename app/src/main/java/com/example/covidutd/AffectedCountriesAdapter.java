...
public class AffectedCountriesAdapter extends ArrayAdapter<CountryModel> {

    private Context context;
    private List<CountryModel> countryModelsList;
    private List<CountryModel> countryModelsListFiltered;

    public AffectedCountriesAdapter(@NonNull Context context,List <CountryModel> countryModelsList) {
